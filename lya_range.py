...
# Extend to colour points based on range of Lya; 0.1 - 0.2, 0.2 - 0.3 etc
...
for X in nm.arange( X_MIN, X_MAX, offset ):
	...
	for Y in nm.arange( Y_MIN, Y_MAX, offset ):
		...
		if ( Lya < 0 and Lya > -0.1 ):
			img.putpixel( ( x_pixel,  y_pixel ), blue ) 

		elif ( Lya >= -0.1 and Lya < -0.2 ):
			img.putpixel( ( x_pixel,  y_pixel ), gold ) 

		elif ( Lya >= -0.2 and Lya < -0.3 ):
			img.putpixel( ( x_pixel,  y_pixel ), red ) 

		elif ( Lya >= -0.3 and Lya < -0.4 ):
			img.putpixel( ( x_pixel,  y_pixel ), cyan ) 

		elif ( Lya >= -0.4 and Lya < -0.5 ):
			img.putpixel( ( x_pixel,  y_pixel ), green ) 

		elif ( Lya >= -0.5 and Lya < -0.6 ):
			img.putpixel( ( x_pixel,  y_pixel ), peach_puff ) 

		elif ( Lya >= -0.6 and Lya < -0.7 ):
			img.putpixel( ( x_pixel,  y_pixel ), linen ) 

		elif ( Lya >= -0.7 and Lya < -0.8 ):
			img.putpixel( ( x_pixel,  y_pixel ), gold ) 

		elif ( Lya >= -0.8 and Lya < -0.9 ):
			img.putpixel( ( x_pixel,  y_pixel ), black ) 
